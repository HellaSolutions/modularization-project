...
public class ${declarationName}HibernateDao extends HibernateDao<${declarationName}, ${c2j.getJavaTypeName(clazz.identifierProperty, jdk5)}> 
	implements ${declarationName}Dao{}