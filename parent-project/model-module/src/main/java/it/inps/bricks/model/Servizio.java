...
/**
 * Servizio generated by hbm2java
 */
public class Servizio  implements java.io.Serializable {
    ...
    public Servizio(TipoContratto tipoContratto, String codice, String descrizione, Date created, Date updated) {
    ...
    public Servizio(TipoContratto tipoContratto, String codice, String descrizione, Date created, Date updated, String user, Set<Attivita> attivitas, Set<TipoTask> tipoTasks) {
       this.tipoContratto = tipoContratto;
       this.codice = codice;
       this.descrizione = descrizione;
       this.created = created;
